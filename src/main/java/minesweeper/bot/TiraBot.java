...
public class TiraBot implements Bot {
    ...
    public Move makeMove(Board board) {
        ...
        Integer type = rng.nextInt(10); //Korvaa tavalla tutkia ympäristö..
        ...
        if (type < 5) {
            ...
            return new Move(MoveType.FLAG, x, y);   // jos jonkin ruudun om oltava miina flag...
        } else {
            if (rng.nextInt(2) == 0) {      // Jos ei voi olla miina (jos kaikki mahdolliset miinat merkattu)
